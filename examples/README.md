...
| `05-feelings-and-plans.txt` | Feelings, open items, plans, sections | The argument stays unresolved; no reason is given for the anxiety; the to-dos stay plans, not things that were done. Feelings and to-dos land in their own sections. |
...
| `11-minimal.txt` | Very short input | A short entry without padding. It must not come back empty, and sections the notes say nothing about stay out. |
